...
const JoinCommunity = () => {
    return (
      <section
        className='call'
        style={{
          backgroundImage: "url('assets/images/background/call-image-01.jpg')",
        }}
      >
          ...
          <div className='row'>
            <div className='col-xl-12'>
              <div className='call-title'>
                ...
                <p data-aos='fade-up' className='mt-6 text-white'>
                ...
                <div data-aos='flip-up' className='header-link-btn mt-8'>
                  <Link href='mailto:contact@rif.ng' className='btn-1 btn-2'>
                    Become A Volunteer
                    <span
                      style={{
                        top: '30px',
