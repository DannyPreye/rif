                    ...
                    <div className="col-xl-12">
                        <div className="call-title">
                            ...
                            <p data-aos="fade-up" className="text-white mt-6">
                                Are you an established entrepreneur, teacher or
                                upcoming professional? Do you see the beautiful
                                work we do at RIF and you believe you can make a
                                firm contribution with your efforts? We
                                encourage you to join us.
                            </p>

                            <p data-aos="fade-up" className="mt-8 text-white">
                                {" "}
                                Click the link below to send us an email. A
                                Designated RIF Representative will reach out to
                                you for a brief assessment call{" "}
                            </p>
                            <div
                                data-aos="flip-up"
